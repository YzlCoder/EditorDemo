...
public class ExtraTransformInspector : DecoratorEditor
{
    public ExtraTransformInspector() : base("TransformInspector") {}
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();//绘制原本的信息
        if (GUILayout.Button("Pos Reset"))
        {
